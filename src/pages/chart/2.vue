    ...
    <div class="w-frame">
      ...
      <div style="display: flex; justify-content: center; align-items: center;">
        ...
        <el-button-group style="margin-left: 5rem;">
          <el-button type="default" @click="saveCharts('pdf',proxy.$refs.chartRef,'能耗同比数据报表');">pdf</el-button>
          <el-button type="default" @click="saveCharts('png',proxy.$refs.chartRef,'能耗同比数据报表');">png</el-button>
          <el-button type="default" @click="saveCharts('jpeg',proxy.$refs.chartRef,'能耗同比数据报表');">jpg</el-button>
        </el-button-group>
      </div>
...
const chart2 = import.meta.globEager('./2chart.js');
const { chartInit, chartChange } = chart2['./2chart.js'];
const changeChart = () => {
  if (isChange.value) {
